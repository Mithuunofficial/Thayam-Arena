...
const getPlayerAvatar = (id: number, isAI: boolean, colorHex: string) => {

  const avatarClass = "w-8 h-8 rounded-full border-2 p-0.5 bg-stone-100 dark:bg-stone-850 flex-shrink-0 transition-all shadow-sm";

  const avatarStyle = { borderColor: colorHex };
  ...
  if (!isAI) {
    ...
    return (
      ...
      <svg className={avatarClass} style={avatarStyle} viewBox="0 0 24 24" fill="none" stroke={colorHex} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">

        <path d="M2 4l3 3 7-5 7 5 3-3v14H2z" fill={`${colorHex}22`} />

        <circle cx="12" cy="11" r="4" fill={`${colorHex}44`} />
  ...
  if (id === 1) {
    ...
    return (
      ...
      <svg className={avatarClass} style={avatarStyle} viewBox="0 0 24 24" fill="none" stroke={colorHex} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">

        <rect x="4" y="9" width="16" height="11" rx="2" fill={`${colorHex}22`} />

        <path d="M9 22v-2h6v2" />

        <path d="M12 9V5M8 5h8" />

        <circle cx="9" cy="14" r="1.2" fill={colorHex} />

        <circle cx="15" cy="14" r="1.2" fill={colorHex} />
    ...
    return (
      ...
      <svg className={avatarClass} style={avatarStyle} viewBox="0 0 24 24" fill="none" stroke={colorHex} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <polygon points="12 2 2 7 12 12 22 7" fill={`${colorHex}22`} />

        <path d="M2 17l10 5 10-5" />

        <path d="M2 12l10 5 10-5" />

        <circle cx="12" cy="7" r="2.2" fill={colorHex} />
    ...
    return (
      ...
      <svg className={avatarClass} style={avatarStyle} viewBox="0 0 24 24" fill="none" stroke={colorHex} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="12" cy="12" r="10" fill={`${colorHex}22`} />

        <path d="M8 14s1.5 2 4 2 4-2 4-2" />

        <line x1="9" y1="9" x2="9.01" y2="9" strokeWidth="3.5" stroke={colorHex} />

        <line x1="15" y1="9" x2="15.01" y2="9" strokeWidth="3.5" stroke={colorHex} />
...
const RosterCoin = ({ id, colorHex }: { id: number; colorHex: string }) => {

  return (

    <div className="relative w-6 h-6 flex-shrink-0 flex items-center justify-center">

      <div className="absolute inset-0.5 rounded-full bg-black/25 translate-y-0.5" />

      <div 

        className="absolute inset-0.5 rounded-full border-[1.5px] border-stone-850 dark:border-stone-900 flex items-center justify-center shadow-sm transition-colors duration-300"
      ...
      >
        ...
        <div className="w-3.5 h-3.5 rounded-full border border-white/30 flex items-center justify-center">
          ...
          <span className="text-[9px] font-black text-white leading-none font-sans select-none" style={{ textShadow: '0px 1px 1.5px rgba(0,0,0,0.5)' }}>
      ...
      <div className="h-0 flex-grow overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-6 p-4 md:p-6 max-w-7xl mx-auto w-full items-stretch">
        ...
        <div className="lg:col-span-3 flex flex-col overflow-hidden h-full">
          ...
          <div className="grid grid-cols-2 gap-3 mb-3 flex-shrink-0">
            ...
            <div className="bg-white dark:bg-[#1E1815] border-4 border-amber-900 dark:border-amber-800 rounded-2xl p-3 flex items-center justify-between shadow-md transition-colors duration-300">

              <div className="flex flex-col text-left">

                <span className="text-[10px] md:text-xs text-stone-500 dark:text-stone-400 font-bold uppercase tracking-wider leading-none">

                  ⏱️ {t.duration}

                </span>

                <span className="text-lg md:text-xl font-black font-mono text-amber-900 dark:text-amber-300 mt-2 leading-none">
            ...
            <div className="bg-white dark:bg-[#1E1815] border-4 border-amber-900 dark:border-amber-800 rounded-2xl p-3 flex flex-col justify-center shadow-md transition-colors duration-300 text-left">

              <span className="text-[10px] md:text-xs text-stone-500 dark:text-stone-400 font-bold uppercase tracking-wider block mb-2 leading-none">
              ...
              <div className="flex flex-wrap gap-1 items-center min-h-[20px]">
                ...
                {rolls.length === 0 ? (
                  ...
                  <span className="text-[10px] md:text-xs text-stone-400 dark:text-stone-500 italic font-medium">
                  ...
                  rolls.map((r, idx) => (
                    ...
                    <span 
                      ...
                      className="px-2 py-0.5 bg-amber-100 dark:bg-amber-900/40 text-amber-900 dark:text-amber-200 border border-amber-500/30 rounded text-[10px] md:text-xs font-black uppercase tracking-wider shadow-sm animate-pulse"
                  ...
                  <div 
                    ...
                    className={`p-2.5 rounded-xl border transition-all duration-300 flex flex-col justify-between ${
                      ...
                      isActive 
                        ...
                        : 'bg-stone-50/40 dark:bg-stone-900/40 border-stone-200/50 dark:border-stone-800'

                    }`}

                  >

                    {/* Top Row: Avatar & Name & Coin */}

                    <div className="flex items-center justify-between gap-1 mb-1">

                      <div className="flex items-center space-x-1 min-w-0">

                        {getPlayerAvatar(p.id, p.isAI, p.colorHex)}

                        

                        <div className="flex flex-col min-w-0 text-left">

                          <span className="font-extrabold text-[10px] md:text-[11px] text-stone-800 dark:text-stone-100 truncate leading-tight" title={p.name}>

                            {p.name}

                          </span>

                          <span className="text-[7.5px] font-bold text-stone-400 dark:text-stone-500 flex items-center space-x-0.5 leading-none mt-0.5">

                            {p.isAI ? (

                              <>

                                <Cpu className="w-2 h-2 text-stone-400 dark:text-stone-500" />
                      ...
                      <RosterCoin id={p.id} colorHex={p.colorHex} />
                    ...
                    <div className="grid grid-cols-3 gap-1 pt-1.5 border-t border-stone-200/40 dark:border-stone-800/40 text-center text-stone-700 dark:text-stone-300">
                      ...
                      <div className="bg-white dark:bg-stone-900 border border-stone-200/50 dark:border-stone-800 p-1 rounded">
                        ...
                        <span className="text-[8px] text-stone-400 dark:text-stone-500 block font-semibold leading-none">{t.base}</span>

                        <span className="text-[10px] font-extrabold leading-tight">{atBase}</span>

                      </div>

                      <div className="bg-white dark:bg-stone-900 border border-stone-200/50 dark:border-stone-800 p-1 rounded">

                        <span className="text-[8px] text-stone-400 dark:text-stone-500 block font-semibold leading-none">{t.board}</span>

                        <span className="text-[10px] font-extrabold text-amber-900 dark:text-amber-300 leading-tight">{onBoard}</span>

                      </div>

                      <div className="bg-white dark:bg-stone-900 border border-stone-200/50 dark:border-stone-800 p-1 rounded">

                        <span className="text-[8px] text-stone-400 dark:text-stone-500 block font-semibold leading-none">{t.home}</span>

                        <span className="text-[10px] font-extrabold text-green-600 dark:text-green-400 leading-tight">{atHome}</span>
        ...
        <div className="lg:col-span-3 flex flex-col space-y-3 overflow-hidden h-full">
          ...
          <div className="bg-white dark:bg-[#1E1815] border-4 border-amber-900 dark:border-amber-800 rounded-2xl p-3 flex-shrink-0 flex flex-col h-[260px] md:h-[280px] shadow-lg transition-colors duration-300 overflow-hidden">
                        ...
                        {rolls.map((r, idx) => {
                          ...
                          if (!move) {
                            ...
                            return (
                              ...
                              <div key={idx} className="p-2.5 bg-stone-50 dark:bg-stone-900 border border-stone-100 dark:border-stone-800 rounded-lg text-stone-400 dark:text-stone-500 text-[10px] italic flex justify-between">
                          ...
                          return (
                            ...
                            >
                              ...
                              <div>
                                ...
                                <span className="font-bold text-stone-800 dark:text-stone-200 block">{lang === 'en' ? 'Move' : 'நகர்வு'} +{r}</span>

                                <span className="text-[9px] text-stone-400 dark:text-stone-400">
                    ...
                    <div className="space-y-3">
                      ...
                      {isMyTurn && turnState === 'moving' && sortedHeuristicMoves.length > 0 ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <span className="text-[9px] text-amber-900 dark:text-amber-300 font-bold uppercase tracking-wider block">
                            ...
                            return (
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <span className={`text-[9px] font-bold block ${idx === 0 ? 'text-green-600 dark:text-green-400' : 'text-stone-500 dark:text-stone-400'}`}>
                                  ...
                                  <span className="text-[9px] text-stone-400 dark:text-stone-500 block font-semibold">{t.usingRoll} {m.rollValue}</span>

                                </div>

                                <span className={`text-[10px] font-bold ${idx === 0 ? 'text-green-600 dark:text-green-400' : 'text-amber-800 dark:text-amber-300'}`}>
                        ...
                        <div className="text-center text-stone-400 dark:text-stone-500 py-8 italic leading-relaxed">
              ...
              <div className="flex-grow flex flex-col justify-between overflow-hidden">
                ...
                <div className="flex-grow overflow-y-auto space-y-1.5 pr-1 text-[11px] font-mono text-stone-600 dark:text-stone-400">
                  ...
                  {logs.length === 0 ? (
                    ...
                    <div className="text-center text-stone-400 dark:text-stone-500 py-8 italic">{t.noRecordsYet}</div>
                    ...
                    logs.map((log, idx) => (
                      ...
                      <div key={log.id || idx} className="border-b border-stone-100 dark:border-stone-900 pb-1">
                        ...
                        <span className="text-[9px] text-stone-400 dark:text-stone-500 mr-1.5">{log.timestamp}</span>
          ...
          <div className="flex-grow overflow-hidden">
            ...
            <Chat
              ...
              messages={[...logs].reverse().map(l => ({
                ...
                senderName: players[l.playerId]?.name || (lang === 'en' ? 'System' : 'அமைப்பு'),
